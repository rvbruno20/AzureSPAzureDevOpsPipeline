...
Azure DevOps pipeline for rotating Azure AD app registration secrets and storing the new values in Azure Key Vault.
...
## PowerShell And Azure Requirements
...
- The checked-in implementation is Azure DevOps YAML plus PowerShell.
